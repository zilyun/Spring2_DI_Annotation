 ...
 * 
 * @Qualifier annotaion을 이용해서 주입될 객체의 아이디나 이름을 지정할 수 있습니다.
 * 
 * @Autowired와 @Qualifier을 한 번에 처리할 수 있는 것이 @Resource 입니다.
 * */
...
public class HelloApp_Autowired {
	public static void main(String[] args) {
		...
		GenericXmlApplicationContext ctx =
				new GenericXmlApplicationContext("com/naver/myhome1/sample2/applicationContext.xml");
